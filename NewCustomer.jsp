...
<script type="text/javascript">
	...
	function validation() {
		...
		if ( passa && passb && passc && passd && passe && passf && passg && passh) {
...
<form action="CustomerServlet?action=insert" method="post" id = "mFormId">
<center><h1> Add New Customer</h1></center>
<table>
<tr>
<td><b>CustomerCode:</td><td><input type="text" name="code"/><br></b><p></td>
</tr>
<tr>
<td><b>CustomerName:</td><td><input onblur = "nameValidation();" type="text" id = "mCustomerName"  name="name"/><br></b><p id = "mCustomerNameId"></td>
</tr>
<tr>
<td><b>CustomerAddress1:</td><td><input onblur = "address1Validation();"type="text" id="mCustomerAddress1" name="Address1"/><br></b><p id="mCustmerAddress1Id"></td>
</tr>
<tr>
<td><b>CustomerAddress2:</td><td><input onblur="address1Validation();" type="text" id="mCustomerAddress1"  name="Address2"/><br></b><p id ="mCustmerAddress1Id"></td>
</tr>
<tr>
<td><b>CustomerPincode:</td><td><input  onblur="pinCodeValidation();"   type="text" id="mCustomerPincode"  name="Pincode"/><br></b><p id="mCustomerPincodeId"></td>
</tr>
<tr>
<td><b>E_mailAddress :</td><td><input   onblur="emailValidation();" type="text"  id="mCustomerEmailAddress" name="E_mailAddress"/><br></b><p id="mCustomerEmailAddressId"></td>
</tr>
<tr>
<td><b>Contact number:</td><td><input  onblur="contactNumberValidation();" type="text" id="mCustomerContactNumber"  name="Contactnumber"/><br></b><p id="mCustomerContactNumberId"></td>
</tr>
<tr>
<td><b>PrimaryContactPerson  :</td><td><input onblur="contactPersonValidation();" type="text" id="mCustomerContactPerson" name="PrimaryContactPerson"/><br></b><p id="mCustomerContactPersonId"></td>
</tr>
